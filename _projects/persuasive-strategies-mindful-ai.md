...
Generative AI tools are now deeply embedded in graduate research workflows, yet their passive use risks eroding the critical thinking, synthesis, and intellectual ownership that graduate training is designed to build. We made a browser-based persuasive AI user interface that promotes mindful engagement through cognitive forcing functions, engagement scoring, gamification, and optional social comparison.

It was designed through an iterative, theory-driven process grounded in the Persuasive Systems Design (PSD) framework, the Transtheoretical Model (TTM), and Social Cognitive Theory (SCT). A low-fidelity prototype was evaluated by six graduate students using a perceived persuasiveness survey, yielding design insights for a high-fidelity prototype (Hi-Fi v1).
...
Hi-Fi v1 was subsequently evaluated in a within-subjects study using TTM, SCT, the System Usability Scale (SUS), and the Perceived Persuasion Scale (PPS). Results show that most participants advanced at least one TTM stage, self-efficacy and self-regulation improved, and the system achieved a mean SUS score of 87.9 and a PPS score of 6.49/7. A refined second version (Hi-Fi v2) addresses remaining concerns around perceived obtrusiveness and monotony.
