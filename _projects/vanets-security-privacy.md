...
This ongoing collaboration investigates the sociotechnical security and privacy challenges of [vehicular ad-hoc networks (VANETs)](https://en.wikipedia.org/wiki/Vehicular_ad_hoc_network), with a focus on [blockchain](https://en.wikipedia.org/wiki/Blockchain)-based trust management and privacy-preserving authentication schemes for connected vehicles.
